...
public class ZooInspectorConnectionPropertiesDialog extends JDialog{
	 ...
	 *            - the last connection properties used. if this is the first connection since starting the applications this will be the default settings
	...
	public ZooInspectorConnectionPropertiesDialog(Properties lastConnectionProps,
			Pair<Map<String, List<String>>, Map<String, String>> connectionPropertiesTemplateAndLabels, final ZooInspectorPanel zooInspectorPanel){
			...
			public void actionPerformed(ActionEvent e){
				...
				if(result == JFileChooser.APPROVE_OPTION){
					...
					try{
						...
						JOptionPane.showMessageDialog(ZooInspectorConnectionPropertiesDialog.this, "An Error occurred loading connection properties from file",
			...
			public void actionPerformed(ActionEvent e){
				...
				try{
					...
					JOptionPane.showMessageDialog(ZooInspectorConnectionPropertiesDialog.this,
							"An Error occurred saving the default connection properties file", "Error", JOptionPane.ERROR_MESSAGE);
				}
			}
		});
