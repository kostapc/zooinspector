...
/**
 * A node viewer for displaying the meta data for the currently selected node. The meta data is essentially the information from the {@link Stat} for the node
 */
public class NodeViewerMetaData extends ZooInspectorNodeViewer {
   ...
   * (non-Javadoc)
   *
   * @see org.apache.zookeeper.inspector.gui.nodeviewer.ZooInspectorNodeViewer# nodeSelectionChanged(java.util.Set)
   */
  @Override
      ...
      SwingWorker<Map<String, String>, Void> worker = new SwingWorker<Map<String, String>, Void>() {
        ...
        protected void done() {
          ...
          try {
            ...
            LoggerFactory.getLogger().error("Error retrieving meta data for node: " + selectedNode, e);
