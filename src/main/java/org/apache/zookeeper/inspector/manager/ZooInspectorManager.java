...
public interface ZooInspectorManager extends ZooInspectorNodeManager, ZooInspectorNodeTreeManager {
   ...
   * <ul>
   * <li>a {@link Map} of property keys to list of possible values. If the list size is 1 the value is taken to be the default value for a
   * {@link JTextField}. If the list size is greater than 1, the values are taken to be the possible options to show in a {@link JComboBox} with the
   * first selected as default.</li>
   * <li>a {@link Map} of property keys to the label to show on the UI</li>
   * <ul>
   */
  ...
  /**
   * @param connectionProps - the connection properties last used to connect to the zookeeeper instance
   */
  public void setLastConnectionProps(Properties connectionProps);

  /**
   * @return last connection Properties - the connection properties last used to connect to the zookeeeper instance
   */
